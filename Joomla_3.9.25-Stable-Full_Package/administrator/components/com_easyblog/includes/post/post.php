...
class EasyBlogPost extends EasyBlog
{
	...
	public function saveRevision()
	{
		...
		if ($this->revision->isFinalized() && (EB::isSiteAdmin() || $this->created_by == $this->my->id || $isArchiveProcess)) {
	...
	public function requiresLoginToRead()
	{
		...
		if ($this->my->guest && $this->config->get('main_login_read')) {
			...
			$message = JText::_('COM_EB_PLEASE_LOGIN_TO_READ_FULL_CONTENT');

			return $this->app->redirect($url, $message);
		}
