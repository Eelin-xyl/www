...
class EasyBlogStylesheet extends EasyBlog
{
	...
	public function attach($minified = true, $allowOverride = true, $customCategoryTemplate = null)
	{
		...
		// Attach mobile toolbar menu
		if (EB::responsive()->isMobile() || EB::responsive()->isTablet()) {
	 ...
	 * @access	public
	 */
	public function attachMobileMenu()
	{
		if (!defined('SI_MMENU')) {
			$css = JURI::root(true) . '/media/com_easyblog/vendors/mmenu/mmenu.css';
