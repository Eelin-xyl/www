			...
			<thead>
				<tr>
					...
					<?php if (!$browse) { ?>
						...
						<th class="nowrap hidden-phone center" width="8%">
							<?php echo JHTML::_('grid.sort', 'COM_EASYBLOG_BLOGS_BLOG_PUBLISHING_DATE', 'a.publish_up', $orderDirection, $order); ?>
						</th>
						<?php } else { ?>
						<th class="nowrap hidden-phone center" width="8%">
							<?php echo JHTML::_('grid.sort', 'COM_EASYBLOG_BLOGS_BLOG_CREATION_DATE', 'a.created', $orderDirection, $order); ?>
						</th>
						<?php } ?>
							...
							<div class="mt-5 eb-table-meta">
								...
								<span>
									<span class="hidden-desktop">
										<a href="<?php echo JRoute::_('index.php?option=com_easyblog&view=bloggers&layout=form&id=' . $row->created_by); ?>"><i class="fa fa-user text-muted"></i> <?php echo JFactory::getUser($row->created_by)->name;?></a>
									</span>
								</span>
								<span>
