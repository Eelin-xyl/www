...
<div class="row">
	<div class="col-lg-6">
		...
		<div class="panel">
			<?php echo $this->html('panel.heading', $fieldsets->tag['grid']->label, $fieldsets->tag['grid']->info); ?>

			<div class="panel-body">
				<?php echo $this->output('admin/settings/views/fields/renderer', array('fields' => $fieldsets->tag['grid']->fields, 'key' => 'tag')); ?>
			</div>
		</div>
	</div>
