...
<div class="row form-horizontal">
	<div class="col-lg-6">
		...
		<div class="panel">
			<?php echo $this->html('panel.heading', 'COM_EB_SETTINGS_FEED_IMPORTER', 'COM_EB_SETTINGS_FEED_IMPORTER_INFO'); ?>

			<div class="panel-body">
				<?php echo $this->html('settings.smalltext', 'main_rss_cronlimit', 'COM_EB_SETTINGS_RSS_CRON_LIMIT', 'COM_EB_SETTINGS_RSS_CRON_LIMIT_DESC', 'COM_EB_LIMIT'); ?>
			</div>
		</div>
	</div>
