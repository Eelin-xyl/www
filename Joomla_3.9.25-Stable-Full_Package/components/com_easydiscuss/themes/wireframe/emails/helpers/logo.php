							...
							<td align="center" style="font-size:0px;padding:5px 0 5px 0;word-break:break-word;">
								...
								<tr>
									<td style="width:180px;">
										<a href="<?php echo JURI::root();?>" target="_blank" style="color: #4e72e2; text-decoration: none;">
											<img height="auto" src="<?php echo $logo;?>" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="180" />
										</a>
									</td>
								</tr>
								</tbody>
