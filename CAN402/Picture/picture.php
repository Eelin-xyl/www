    ...
    <table>
        <tr height=400px>
            ...
            <td>
                ...
                <a href="like.php?pid=<?= $pid ?>&like=like&status=<?= $status ?>"><img src="../Image/<?= $plike ?>" width="50px" height="50px"></a><?= $like ?>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="like.php?pid=<?= $pid ?>&like=dislike&status=<?= $status ?>"><img src="../Image/<?= $pdislike ?>" width="50px" height="50px"></a><?= $dislike ?>
            </td>
        </tr>
        <?php
